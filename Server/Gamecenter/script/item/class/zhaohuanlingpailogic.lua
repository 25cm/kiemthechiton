...
function tb:PlayerAccredit(nMapId, nPosX, nPosY, nMemberPlayerId, nFightState, bAccept)
	...
	GeneralProcess:StartProcess("G?i yêu c?u cu?c g?i...", self.nTime * Env.GAME_FPS, {self.SendAllMemberSuccess, self, nTempMapId, nTempPosX, nTempPosY, nTempMemberPlayerId, nTempFightState}, nil, tbEvent);	-- 在战斗状态下需要nTime秒的延时
end
