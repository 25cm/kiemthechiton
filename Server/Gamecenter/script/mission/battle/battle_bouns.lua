...
function Battle:AwardJbCoin(tbPlayerList)
	...
	tbBattleInfo.pPlayer.AddStackItem(18,1,1194,11,nil,1);
			...
			tbBattleInfo.pPlayer.Msg("<color=green>Hành trang trống >=5 để nhận<color> <color=yellow>Phần Thưởng 15 Vạn Đồng<color>");
			----------------------------------------------
	...
	tbBattleInfo.pPlayer.AddStackItem(18,1,1194,12,nil,1);
			...
			tbBattleInfo.pPlayer.Msg("<color=green>Hành trang trống >=5 để nhận<color> <color=yellow>Phần Thưởng 12 Vạn Đồng<color>");
		elseif (3 == i ) then
	tbBattleInfo.pPlayer.AddStackItem(18,1,1194,13,nil,1);
			...
			tbBattleInfo.pPlayer.AddBindCoin(80000);
			tbBattleInfo.pPlayer.Msg("<color=green>Hành trang trống >=5 để nhận<color> <color=yellow>Phần Thưởng 10 Vạn Đồng<color>");
		elseif (4 <= i ) then
	tbBattleInfo.pPlayer.AddStackItem(18,1,1194,14,nil,1);
			...
			tbBattleInfo.pPlayer.Msg("<color=green>Hành trang trống >=5 để nhận<color> <color=yellow>Phần Thưởng 7 Vạn Đồng<color>");
		elseif (11<= i ) then
	tbBattleInfo.pPlayer.AddStackItem(18,1,1194,15,nil,1);
			...
			tbBattleInfo.pPlayer.Msg("<color=green>Hành trang trống >=5 để nhận<color> <color=yellow>Phần Thưởng 5 Vạn Đồng<color>");
		elseif (21 <= i ) then
	tbBattleInfo.pPlayer.AddStackItem(18,1,1194,16,nil,1);
			...
			tbBattleInfo.pPlayer.Msg("<color=green>Hành trang trống >=5 để nhận<color> <color=yellow>Phần Thưởng 3 Vạn Đồng<color>");
		end
	end
end
-- 战局结束时的声望按排名奖励
