...
DISPENSE_TIME 			= 1 * 3600 		-- 两次分发资金的时间间隔要求6小时
DISPENSE_AGREE_COUNT	= 1				-- 申请发放需要达到同意的个数 1个
DISPENSE_APPLY_LAST		= 10 * 60 * 18	-- 发放的申请延时 10分钟
TAKEFUND_TIME			= 1 * 3600		-- 两次取资金的时间间隔要求6小时
STORAGEFUND_TO_KIN_TIME	= 1 * 3600		-- 两次转存帮会资金到家族的时间
...
KICK_KIN_AGREE_COUNT	= 0				-- 开除家族需要达到的同意个数
