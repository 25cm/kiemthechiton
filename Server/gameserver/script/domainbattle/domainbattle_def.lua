...
SCORE_JIANGLING		= 100;
SCORE_SHIBING		= 50;
SCORE_PER_KILL		= 100;		-- 每杀一个人获得的功勋
SCORE_PER_TOWER		= 2000;		-- 攻占一个箭塔获得的功勋
...
BATTLE_TIME			= 25 * 60	-- 征战时间 60分钟
STOP_TIME			= 10 * 60	-- 休战时间 10分钟

ADDBOSS_TIME		= 5 * 60	-- 每15分钟1刷
...
TONG_AWARD_DAY = {1, 2, 3, 4, 5, 6, 0};
TONG_AWARD_START_TIME = 2200;
TONG_AWARD_END_TIME = 2230;
