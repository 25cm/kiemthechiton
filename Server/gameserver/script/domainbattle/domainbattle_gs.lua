...
function Domain:StartDomainBattle_GS2(nBattleNo, nDataVer)
	...
	local szMsg = "<color=green>Tranh Đoạt Lãnh Thổ<color> đang bước vào thời kỳ <color=red>Tuyên Chiến<color>, các bang chủ hãy đến gặp <color=blue>Quan Lãnh Thổ<color> để xác định mục tiêu chinh chiến"
	KDialog.NewsMsg(0, Env.NEWSMSG_NORMAL, szMsg);
	KDialog.MsgToGlobal("<color=green>Tranh Đoạt Lãnh Thổ<color> đang bước vào thời kỳ <color=gold>Tuyên Chiến<color>, các bang chủ hãy đến gặp <color=blue>Quan Lãnh Thổ<color> để xác định mục tiêu chinh chiến");
end
