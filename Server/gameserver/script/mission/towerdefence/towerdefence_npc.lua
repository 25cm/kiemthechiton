...
{"活动开启时间",string.format([[
    比赛共分三个阶段：
    家族选拔赛阶段：单人混战。每个月的7号~20号，共计14天，活动开启时间为每天的上午10点—14点，下午17点—午夜23点，每15分钟开启一场，10点为第一场，22：45为每天最后一场，报名时间5分钟。
...
{"如何参加比赛",[[
    活动开启后，60级以上的玩家可以去各新手村找晏若雪报名参加，每个玩家每天有2次机会。参加比赛必须有自己的专属先祖庇护符，先祖庇护符可以采取一定方式获得，同时还能进行额外改造，使其具有各种特殊能力。]]
},
{"如何获得专属先祖庇护符",[[
    先祖庇护符的获取方式：去杂货店购买月影原石，利用生活技能制作出月影之石，再去晏若雪处换取。1个月影之石换取先祖庇护，5个月影之石可换取先祖庇护·凤凰。
    ]]
},
{"了解先祖庇护符改造",[[
    先祖庇护符改造共有五个技能可供选择。
