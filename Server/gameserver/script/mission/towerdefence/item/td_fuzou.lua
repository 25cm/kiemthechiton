...
tbItem.PRODUCT_SKILL = {
	...
	[1] = {
		...
		{1611, "定", "使目标定身3秒，定点攻击。",{[1]=1,[2]=1}, 15000},
		{1612, "退", "使目标击退距离，定点攻击。",{[1]=1,[2]=1}, 15000},
		{1613, "缓", "使目标迟缓5秒，定点攻击。",{[1]=1,[2]=1}, 15000},
		{1614, "乱", "使目标混乱2秒，定点攻击。",{[1]=1,[2]=1}, 15000},
		{1615, "晕", "使目标眩晕2秒，定点攻击。",{[1]=1,[2]=1}, 15000},
	},
};
