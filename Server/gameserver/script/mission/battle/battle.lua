...
function Battle:SendBTOpenInfo()
	local szMsg = string.format("<color=green>Đại chiến Tống Kim<color> hiện đang tiến hành báo danh, thời gian báo danh còn:<color=red> 5 Phút<color>");
	KDialog.NewsMsg(0, Env.NEWSMSG_NORMAL, szMsg);
	KDialog.MsgToGlobal("<color=yellow>Đại chiến Tống Kim<color> hiện đang tiến hành báo danh, thời gian báo danh còn:<color=green> 5 Phút<color>");
end
