...
Partner.MAXPERSUADEDISTANCE		 = 1000;		-- 玩家说服NPC的时候，与NPC的距离不能大于520
Partner.SHAREEXPDISTANCE		 = 1000;		-- 杀死NPC的时候，与NPC的距离在该值内的队友都能分享经验和亲密度
Partner.CALLPROCESSTIME			 = 1;		-- 召唤同伴的时候，需要读条15秒
...
Partner.SKILLCOUNTMIN 			 = 3;		-- 目前配置文件中设定每个同伴最小技能数为2
