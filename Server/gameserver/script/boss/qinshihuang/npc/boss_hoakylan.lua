...
function tbQinshihuangBoss:DeathLoseItem(tbLoseItem)
	...
	local szMsg = "<color=green>Hỏa Kỳ Lân rơi vật phẩm:<color>\n";
	local tbList = {};
...
local szMsg = string.format("Tổ đội của <color=green>%s<color> tại <color=green>"..GetMapNameFormId(nMapId).."<color> hạ gục <color=green>Hỏa Kỳ Lân<color>!!!", pPlayer.szName);
GlobalExcute({"Dialog:GlobalNewsMsg_GS","<color=red>[Anh Hùng] <color><color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục <color=green>Hỏa Kỳ Lân<color> "});
	KDialog.NewsMsg(1, Env.NEWSMSG_COUNT,"<color=red>[Anh Hùng] <color><color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục <color=green>Hỏa Kỳ Lân<color> ");
	KDialog.MsgToGlobal("<color=red>[Anh Hùng]<color> <color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục <color=green>Hỏa Kỳ Lân<color> ");	
	KDialog.NewsMsg(0, Env.NEWSMSG_COUNT, szMsg);
	self:BroadCast(szMsg);
		local nNpcMapId, nNpcPosX, nNpcPosY = him.GetWorldPos();
	KNpc.Add2(9648, 1, 0, nNpcMapId, nNpcPosX, nNpcPosY)
