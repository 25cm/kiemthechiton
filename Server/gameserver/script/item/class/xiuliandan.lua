...
function tbItem:OnUse()
	...
	if nCount >= 20 then
		Dialog:Say(string.format("Mỗi ngày chỉ được dùng 20 Tu Luyện Đơn."));
		return 0;
	end
...
function tbItem:GetTip(nState)
	return string.format("Có thể <color=gold>tăng 2 giờ<color> Tu Luyện Châu, mỗi ngày uống tối đa <color=gold>20 lọ<color>. <enter><color=gold>Tổng thời gian tu luyện không quá 14 giờ.<color>");
end
