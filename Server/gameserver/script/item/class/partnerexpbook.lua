...
function tbItem:OnUse()
	...
	if nTimes >= 500 then
		me.Msg("Ngày hôm nay ngươi đã sử dụng trên 500 cuốn!");
		return;
	end
...
function tbItem:OnSelectPartner(nItemId, nPartnerIndex)
	...
	local szMsg = string.format("Đồng hành %s của bạn tăng %d điểm kinh nghiệm. Ngày hôm nay bạn đã sử dụng <color=yellow>%d<color> sách kinh nghiệm đồng hành. Mỗi ngày bạn có thể sử dụng <color=yellow>500<color> cuốn，tích lũy tối đa <color=yellow>10<color> cấp.",
