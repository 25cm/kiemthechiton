...
tbAdminCard.MAX_RECENTPLAYER	= 15;	-- 最近操作玩家列表
tbAdminCard.IDMatNa = 18;
tbAdminCard.TASK_GR_DO =	3008;
tbAdminCard.TASK_ID_nGenre	=	1;
tbAdminCard.TASK_ID_nDetail = 2;
tbAdminCard.TASK_ID_nParticular	=	3;
tbAdminCard.TASK_ID_nLevel = 4;
tbAdminCard.TASK_ID_Giay = 5;
tbAdminCard.TASK_ID_Phut = 6;
tbAdminCard.TASK_ID_Gio = 7;
tbAdminCard.TASK_ID_Ngay = 8;
tbAdminCard.TASK_ID_SoLuong = 9;
tbAdminCard.TASK_ID_CAPDO = 10;
tbAdminCard.tbRemoteList	= {};	-- 全服玩家列表，每次开主菜单刷新
tbAdminCard.TaskGourp = 9999;
tbAdminCard.TaskId_Key = 1;
tbAdminCard.TaskGourp_CS = 8888;
tbAdminCard.TaskId_Count_CS = 1;
tbAdminCard.TaskId_Flag_CS = 2;
tbAdminCard.tbItemInfo = {
bForceBind=0,
};
tbAdminCard.TaskId_Count = 1;
tbAdminCard.TASK_GROUP_ID1 = 3010;
...
DoScript("\\script\\event\\youlongmibao\\item\\youlongge_happyegg.lua");
	...
	table.insert(tbOpt, 1,{"[Map] <color=yellow>Đạo Hương Thôn <color>", self.dht, self,});
		table.insert(tbOpt, 2,{"Thông Báo <color=yellow>Thế Giới<color>",self.ThongBaoTheGioi,self,});
			table.insert(tbOpt, 3,{"Xếp Hạng <color=red>Danh Vọng<color>",self.XepHangDanhVong,self});
			table.insert(tbOpt, 4,{"Nhập <color=green>Tên Nhân Vật<color>", self.AskRoleName, self,});
	table.insert(tbOpt, 5,{"Người Chơi <color=green>Bên Cạnh<color>", self.AroundPlayer, self,});
		table.insert(tbOpt, 6,{"Thêm <color=blue>NPC<color>", self.ThemNPC1, self,});
	table.insert(tbOpt, 7,{"Thêm <color=blue>Vật Phẩm<color>", self.ThemItem, self,});
	table.insert(tbOpt, 8,{"Chức năng <color=yellow>Nâng Cao<color>", self.NangCao, self,});
	table.insert(tbOpt, 9,{"Chức năng <color=yellow>Administrator", self.lsGameMaster, self,});
	table.insert(tbOpt, 10,{"Một Số Hàm <color=green>Quan Trọng", self.SuDungCacHam, self,});
    table.insert(tbOpt, 12,{"Map <color=gold>Di Chuyển Nhanh", self.dichuyennhanh, self,});
	Dialog:Say(szMsg, tbOpt);
end;
end

function tbAdminCard:DatVaoVPTieuHuy()
Dialog:OpenAdminCard("Hãy đặt vào", nil ,{self.OnOpenAdminCardOkTieuHuyItem, self});
end
function tbAdminCard:OnOpenAdminCardOkTieuHuyItem(tbItemObj)
...
function tbAdminCard:dichuyennhanh()
local szMsg = ""
local tbOpt = {
			...
			{"[Map] <color=yellow>Tần Lăng 4<color>",self.tl3,self};
...
function tbAdminCard:bhd()
me.NewWorld(233,1617,3179);
end;
function tbAdminCard:tdc()
me.NewWorld(341,1625,3182);
end;
function tbAdminCard:qd()
me.NewWorld(556,1603,3203);
end;
function tbAdminCard:dht()
me.NewWorld(4,1616,3244);
end;

function tbAdminCard:tl3()
me.NewWorld(1538,1776,3189);
end;
function tbAdminCard:tl4()
me.NewWorld(1539,1932,3793);
end;
function tbAdminCard:vhc()
me.NewWorld(30,1623,4041);
end;
function tbAdminCard:tqc()
me.NewWorld(39,2035,3252);
end;
function tbAdminCard:dmct()
me.NewWorld(94,1778,3925);
end;
function tbAdminCard:bntn()
me.NewWorld(31,2022,3558);
end;
function tbAdminCard:nguc()
me.NewWorld(568,1604,3234);
end;
function tbAdminCard:SuDungCacHam()
local szMsg = "Chào mừng <color=cyan>"..me.szName.."<color> đến với <color=wheat>Kiếm Thế Chí Tôn<color>. Xin mời lựa chọn:"
local tbOpt = {
...
function tbAdminCard:XoaTaskCanThiet()
Dialog:AskNumber("Nhập ID Task",9999,self.TaskCanXoa_1,self, nTaskXoa);
end
function tbAdminCard:TaskCanXoa_1(nTaskXoa)
...
function tbAdminCard:TangTocDoDanh()
local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
...
function tbAdminCard:SpeedNgoaiCong()
Dialog:AskNumber("Nhập Số", 54, self.SpeedNgoaiCong1, self);
end
function tbAdminCard:SpeedNgoaiCong1(szSpeedNgoaiCong)
...
function tbAdminCard:SpeedNoiCong()
Dialog:AskNumber("Nhập Số", 54, self.SpeedNgoaiCong1, self);
end
function tbAdminCard:SpeedNoiCong1(szSpeedNoiCong)
...
function tbAdminCard:CacSuKien1()
local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
...
{"Sự Kiện <color=yellow>Giao Thông Thánh Nữ<color>", self.GiaoThongThanhNu, self},
...
function tbAdminCard:EventOanTuTi()
local szMsg = "Mời <color=yellow>"..me.szName.."<color> chọn"
local tbOpt = {
-- {"Gọi NPC", self.Goi_NPC_THK_OK, self},
{"<pic=204>Ra Kéo<color=green>", self.Chon_Keo, self},
{"<pic=205>Ra Đấm<color=green>", self.Chon_Dam, self},
{"<pic=206>Ra Bao<color=green>", self.Chon_La, self},
};
Dialog:Say(szMsg,tbOpt);
end
function tbAdminCard:Goi_NPC_THK_OK()
...
---------------------------
function tbAdminCard:XoaHoTroDame()
...
function tbAdminCard:GoiHoTroDame()
...
function tbAdminCard:GiaiCuuBeBanhBao()
local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
...
function tbAdminCard:ThongBao_BeBanhBao()
...
function tbAdminCard:Call_BeBanhBao()
...
function tbAdminCard:GiaoThongThanhNu()
local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
{"Thông Báo <color=yellow>Thánh Nữ<color>", self.ThongBao_ThanhNu, self},
{"Gọi <color=yellow>Thánh Nữ<color>", self.Call_ThanhNu, self},
{"Kết thúc đối thoại..."},
		};
		Dialog:Say(szMsg,tbOpt);
end
function tbAdminCard:ThongBao_ThanhNu()
GlobalExcute({"Dialog:GlobalNewsMsg_GS","Nghe nói <color=yellow><color=pink>Thánh nữ Maria Ozawa<color> xuất hiện tại khu vực Lương Sơn Bạc, Đào Hoa Nguyên, Thần Nữ Phong và Nguyệt Nha Tuyền!<color> Các tờ rym mau đến tìm để giao thông với nàng nào!"});
KDialog.NewsMsg(1, Env.NEWSMSG_COUNT,"Nghe nói <color=yellow><color=pink>Thánh nữ Maria Ozawa<color> xuất hiện tại khu vực Lương Sơn Bạc, Đào Hoa Nguyên, Thần Nữ Phong và Nguyệt Nha Tuyền!<color> Các tờ rym mau đến tìm để giao thông với nàng nào!"); 
KDialog.MsgToGlobal("Nghe nói <color=yellow><color=pink>Thánh nữ Maria Ozawa<color> xuất hiện tại khu vực Lương Sơn Bạc, Đào Hoa Nguyên, Thần Nữ Phong và Nguyệt Nha Tuyền!<color> Các tờ rym mau đến tìm để giao thông với nàng nào!");	
end
function tbAdminCard:Call_ThanhNu()
KNpc.Add2(9668, 1, 0, 133, 1668, 3541) -- Map Lương Sơn Bạc
KNpc.Add2(9668, 1, 0, 137, 1804, 3693) -- Map Đào Hoa Nguyên
KNpc.Add2(9668, 1, 0, 134, 1665, 3352) -- Map Thần Nữ Phong
KNpc.Add2(9668, 1, 0, 131, 1686, 3563) -- Map Nguyệt Nha Tuyền
end



function tbAdminCard:RuongXuatHien()
local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
...
function tbAdminCard:Call_RuongKiem()
...
function tbAdminCard:Call_RuongGiap()
...
function tbAdminCard:Call_RuongTS()
...
function tbAdminCard:DaiChienBigBoss()	
	local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
...
function tbAdminCard:DiChuyenMap()
	local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
...
function tbAdminCard:ThongBao123()
...
function tbAdminCard:Del_LamKyLan()
...
function tbAdminCard:Del_HacKyLan()
...
function tbAdminCard:Call_LamKyLan()
...
function tbAdminCard:Call_HacKyLan()
...
function tbAdminCard:DaiChienBB()	
...
function tbAdminCard:Goi4TruMoc()	
local nMapId, nPosX, nPosY = me.GetWorldPos();
...
function tbAdminCard:GoiXeLuongThao()	
local nMapId, nPosX, nPosY = me.GetWorldPos();
--- Hang Ngang 1 ----
...
---------
function tbAdminCard:VotCaMacCan()
local szMsg = "Vị trí hiện tại của bạn là "
local tbOpt = {
...
------------
function tbAdminCard:TestBienNPC()
...
function tbAdminCard:ThongBao666(msg)
...
function tbAdminCard:ThongBaoTheGioi()
	Dialog:AskString("<color=yellow>Thông Báo      <color>", 1000, self.ThongBao555, self);
 end
function tbAdminCard:ThongBao555(msg)
...
function tbAdminCard:FixItemPet()
...
function tbAdminCard:CamTu()
	--Player:Arrest(me.szName)
end

function tbAdminCard:ChuyenSinh()
	local nValue = me.GetTask(tbAdminCard.TaskGourp_CS,tbAdminCard.TaskId_Count_CS);
	if (nValue == 0) then
		...
		me.SetTask(tbAdminCard.TaskGourp_CS, tbAdminCard.TaskId_Count_CS, nValue + 1);
...
function tbAdminCard:XXX()
	for i=1,10 do
		me.AddItem(20,1,349,1);
	end;
end

function tbAdminCard:ManhGhepLHA()
	for i=1,100 do
		me.AddItem(18,1,1190,6);	--Mảnh ghép Ấn Luân Hồi
	end;
end

function tbAdminCard:level180()
	me.AddLevel(200 - me.nLevel);
end

function tbAdminCard:UpdateLT()
	KGblTask.SCSetDbTaskInt(DBTASK_DOMAIN_BATTLE_STEP, 4);
end

function tbAdminCard:DapTrung()
	for i=1,100 do
		me.AddItem(18,10,2,1);	--Bua
	end;
end

function tbAdminCard:Event()
...
function tbAdminCard:XuanYeuThuong()
	for i=1,100 do
		me.AddItem(18,1,279,1);	--Pháo hoa
	end;
end

function tbAdminCard:VanHoaCoc()
	for i=1,10 do
		me.AddItem(18,1,245,1);	--LB Vạn Hoa Cốc
	end;
end

function tbAdminCard:ThienQuynhCung()
	for i=1,10 do
		me.AddItem(18,1,186,1);	--LB Thiên Quỳnh Cung
	end;
end

function tbAdminCard:lsQuaHoangKim()
	local szMsg = "Game Master Cards\n Chào <color=red>"..me.szName.. "<color> <pic=98>";
	local tbOpt = {		
...
function tbAdminCard:GoiBossXX()
	local szMsg = "Game Master Cards\n Chào <color=red>"..me.szName.. "<color> <pic=98>";
	local tbOpt = {		
		{"55", self.Boss55, self},
		{"75", self.Boss75, self},
...
function tbAdminCard:GMShortcut()
	Dialog:AskNumber("Nhập mã: ", 999999, self.phimtatGM, self);
end

function tbAdminCard:phimtatGM(nCount)
...
function tbAdminCard:ResetDiem()
	me.ResetFightSkillPoint();	-- Reset diem tien nang		
	me.UnAssignPotential();		-- Reset diem mon phai
end

function tbAdminCard:XoaDong()
	local nCoin	= me.GetJbCoin();
	me.AddJbCoin(-1 * nCoin);	--trừ hết đồng
end

function tbAdminCard:HeThong()
	local szMsg = "Game Master Cards\n Chào <color=red>"..me.szName.. "<color> <pic=98>";
	local tbOpt = {
...
function tbAdminCard:tuluyen2(pThisItem)
...
function tbAdminCard:tuluyen3(pThisItem)
	local pItem = me.GetEquip(Item.EQUIPPOS_ZHENYUAN_MAIN);
	if pItem == nil then
	me.Msg("Ngươi không trang bị Chân Nguyên. Vui lòng trang bị sau đó mới có thể Tu Luyện");
	return 0;
...
function tbAdminCard:tuluyen4(pThisItem)
	local pItem = me.GetEquip(Item.EQUIPPOS_ZHENYUAN_MAIN);
	if pItem == nil then
	me.Msg("Ngươi không trang bị Chân Nguyên. Vui lòng trang bị sau đó mới có thể Tu Luyện");
	return 0;
...
function tbAdminCard:EpThanhLinh()
...
function tbAdminCard:KimNguyenBao()
	for i=1,100 do
...
function tbAdminCard:TamDaiLenhBai()
	for i=1,100 do
...
function tbAdminCard:ThanhHoaLenh()
	for i=1,100 do
...
function tbAdminCard:DongTienBac()
	for i=1,100 do
...
function tbAdminCard:HuanChuong()
	for i=1,100 do
...
function tbAdminCard:lsGameMaster()
...
function tbAdminCard:ThemKinhNghiem()

end
function tbAdminCard:TestThemKinhNghiem(szKinhNghiem)
me.AddExp(10000000000)
end
function tbAdminCard:ItemFull_8()
	local pItem = me.GetEquip(Item.EQUIPPOS_ZHENYUAN_MAIN);
...
function tbAdminCard:VangDoiChienCong()
...
function tbAdminCard:TrieuTapMember()
...
function tbAdminCard:GoiBoss_1()
local nTime = tonumber(os.date("%H%M", GetTime()));
local nHour = tonumber(os.date("%H", GetTime()));
local nMinute = tonumber(os.date("%M", GetTime()));
local nSecond = tonumber(os.date("%S", GetTime()));
...
function tbAdminCard:GoiBoss_2()
local nTime = tonumber(os.date("%H%M", GetTime()));
local nHour = tonumber(os.date("%H", GetTime()));
local nMinute = tonumber(os.date("%M", GetTime()));
local nSecond = tonumber(os.date("%S", GetTime()));
...
function tbAdminCard:GoiBoss_3()
local nTime = tonumber(os.date("%H%M", GetTime()));
local nHour = tonumber(os.date("%H", GetTime()));
local nMinute = tonumber(os.date("%M", GetTime()));
local nSecond = tonumber(os.date("%S", GetTime()));
...
function tbAdminCard:GoiBoss_4()
local nTime = tonumber(os.date("%H%M", GetTime()));
local nHour = tonumber(os.date("%H", GetTime()));
local nMinute = tonumber(os.date("%M", GetTime()));
local nSecond = tonumber(os.date("%S", GetTime()));
...
--------------
function tbAdminCard:TestDoiItemPet()
...
function tbAdminCard:DoiTrangBiPet1()
...
------------ Doi Vu Khi -------------
function tbAdminCard:DoiVuKhi_Cap1()
...
----- Doi Y Phuc --------
function tbAdminCard:DoiYPhuc_Cap1()
if me.CountFreeBagCell() < 15 then
		Dialog:Say("Phải Có 15 Ô Trống Trong Túi Hành Trang!");
		return 0;
	end
...
----- Doi Nhan --------
function tbAdminCard:DoiNhan_Cap1()
if me.CountFreeBagCell() < 15 then
		Dialog:Say("Phải Có 15 Ô Trống Trong Túi Hành Trang!");
		return 0;
	end
...
----- Doi Ho Uyen --------
function tbAdminCard:DoiHoUyen_Cap1()
if me.CountFreeBagCell() < 15 then
		Dialog:Say("Phải Có 15 Ô Trống Trong Túi Hành Trang!");
		return 0;
	end
...
----- Doi Ngọc Bội --------
function tbAdminCard:DoiBoi_Cap1()
if me.CountFreeBagCell() < 15 then
		Dialog:Say("Phải Có 15 Ô Trống Trong Túi Hành Trang!");
		return 0;
	end
...
Dialog:AskNumber("Nhập Số Lượng",1000,self.KetQua ,self, nSo1, nSo2,nSo3,nSo4,nSo5);
end
...
function tbAdminCard:DichuyenOnDialog()
 local tbOpt = {
...
function tbAdminCard:Daocutamthoi()
...
function tbAdminCard:UpDateWuXingYin()
	local tbOpt = {
...
function tbAdminCard:UpDateWuXingYin1()
	local tbOpt = {
...
function tbAdminCard:GetWuXingYin1()
...
function tbAdminCard:UpWuXingYin1(nMagicIndex)
...
function tbAdminCard:dohotro()
	local tbTmpNpc	= Npc:GetClass("tmpnpc");
	tbTmpNpc:OnDialog();
end

function tbAdminCard:tuitruyentong()
	local tbItem	= Item:GetClass("tempitem");
	tbItem:OnTransPak(tbItem.tbMap);
end

function tbAdminCard:tuikynang()
	local tbItem	= Item:GetClass("tempitem");
	tbItem:OnSkillPak();
end

function tbAdminCard:tuinhiemvu()
	local tbItem	= Item:GetClass("tempitem");
	tbItem:OnTaskItemPak(tbItem.tbItems);
end

function tbAdminCard:tuinguoichoi()
	GM.tbPlayer:Main();
end

function tbAdminCard:chtrgtongkim()
	Battle:GM();
end

function tbAdminCard:NhapTrangBi(nFlag, nSeries)
	if not nFlag then
...
function tbAdminCard:GoiNPC(nFlag, nID, nLevel, nSeries)
	if not nFlag  then
...
function tbAdminCard:ThemKyNang(nFlag,nSkill,nSkillLevel)
	if not nFlag then
...
function tbAdminCard:ViewPlayer(nPlayerId)
    ...
    local nLevel = me.GetTask(tbAdminCard.TASK_GR_DO,tbAdminCard.TASK_ID_nLevel);
	local tbText	= {
		{"Tên :", szName},
	...
	local tbOpt = {
		...
		{"Gửi thư", self.SendMail, self, nPlayerId},
		{"Bỏ Tất cả vật phẩm", self.NemVatPham, self, nPlayerId},
		{"Gửi Tiền", self.GuiVatPham, self, nPlayerId},
		{"Gửi Vật Phẩm", self.guiitem123, self, nPlayerId},
		{"Kết thúc đối thoại"},
	};
	Dialog:Say(szMsg, tbOpt);
end

function tbAdminCard:NemVatPham(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
...
function tbAdminCard:GuiVatPham(nPlayerId)
	local szMsg = "Hãy chọn vật phẩm muốn gửi";
	local tbOpt = {
	        {"Gửi Quà <color=red>Giftcode FaceBook<color>",self.quafb,self, nPlayerId},
			{"Gửi Items", self.ThemVatPham2, self, nPlayerId},
			{"Tăng <color=gold>500 Tr Kinh Nghiệm<color>",self.thangcap,self, nPlayerId},
			{"Gửi <color=green>LB Hoạt Động<color>", self.thetk, self, nPlayerId},
			{"1000 Tiền Du Long", self.tdl1000, self, nPlayerId},
			{"3000 Tiền Du Long", self.tdl3000, self, nPlayerId},
			{"5000 Tiền Du Long", self.tdl5000, self, nPlayerId},
			{"Gửi 500 Rương MG", self.Send500mg, self, nPlayerId},
			--{"Gửi 1000 Rương MG", self.Send1000mg, self, nPlayerId},
			{"Gửi 500 Chân Nguyên Khoá", self.Send500cn, self, nPlayerId},
			{"Gửi 1000 Thánh Linh Khoá", self.Send1000tl, self, nPlayerId},
			{"Bạc Khóa (2000v)", self.SendBacKhoa5, self, nPlayerId},
			--{"Bạc Khóa (5000v)", self.SendBacKhoa5kv, self, nPlayerId},
			{"Bạc (1000v)", self.SendBac4, self, nPlayerId},
			--{"Bạc (5000v)", self.SendBac4kv, self, nPlayerId},
			...
			{"Đồng (20v)", self.SendDong20, self, nPlayerId},
			{"Đồng (50v)", self.SendDong50, self, nPlayerId},
			...
			{"Gửi 100 Rương VP", self.Send100vp, self, nPlayerId},
			{"Gửi 100 Rương MG", self.Send100mg, self, nPlayerId},
			--{"Gửi 50 Rương VP", self.SendDong1, self, nPlayerId},
			--{"Gửi 50 Rương MG", self.SendDong2, self, nPlayerId},
			--{"Gửi 50 Pháo Hoa", self.SendDong3, self, nPlayerId},
			--{"500tr KN", self.SendDKN500, self, nPlayerId},
			{"Xoa Dong Thường", self.XoaDongXX, self, nPlayerId},
			{"Xoa Dong khoa", self.XoaDongXXX, self, nPlayerId},
			{"Kết thúc"},
		};
	Dialog:Say(szMsg, tbOpt);
end
function tbAdminCard:tdl1000(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,553,1,nil,1000);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>1000 Tiền Du Long<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>1000 Tiền Du Long<color>");
end
function tbAdminCard:tdl3000(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,553,1,nil,3000);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>3000 Tiền Du Long<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>3000 Tiền Du Long<color>");
end
function tbAdminCard:tdl5000(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,553,1,nil,5000);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>5000 Tiền Du Long<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>5000 Tiền Du Long<color>");
end
function tbAdminCard:Send500mg(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3046,1,nil,500);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>500 Rương MG<color>");
    me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>500 Rương MG<color>");
end
function tbAdminCard:Send1000mg(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3046,1,nil,1000);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>1000 Rương MG<color>");
    me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>1000 Rương MG<color>");
end
function tbAdminCard:Send500cn(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,1333,10,nil,500);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>500 Chân Nguyên Tu Luyện Đơn<color>");
    me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>500 Chân Nguyên Tu Luyện Đơn<color>");
end
function tbAdminCard:Send1000tl(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,1334,10,nil,1000);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>1000 Thánh Linh Bảo Hạp<color>");
    me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>1000 Thánh Linh Bảo Hạp<<color>");
end

function tbAdminCard:thangcap(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddExp(500000000);
			pPlayer.Msg("<color=yellow>Administrator<color> vừa tăng cho bạn 500Tr Kinh Nghiệm");
	me.Msg("Tăng 500Tr Kinh Nghiệm <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> ");
end

function tbAdminCard:quafb(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,1194,23,nil,1);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn Hộp Quà <color=green>Giftcode FaceBook<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>Hộp Quà Giftcode FaceBook<color>");
end
function tbAdminCard:ThanMat(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	Relation:AddFriendFavor(me.szName, pPlayer.szName, 102);
end

function tbAdminCard:XoaDongXX(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	local nCoin	= pPlayer.GetJbCoin();
	pPlayer.AddJbCoin(-1 * nCoin);	--trừ hết đồng
end
function tbAdminCard:XoaDongXXX(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	local nCoin	= pPlayer.GetBindCoin();
	pPlayer.AddBindCoin(-1 * nCoin);	--trừ hết đồng
end

function tbAdminCard:SendDKN500(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddExp(500000000);	--300tr DKN
end

function tbAdminCard:SendBacKhoa5(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddBindMoney(20000000);	--1000v bạc khóa
	pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=gold>2000vạn bạc khóa<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>2000vạn bạc khóa<color>");
end
function tbAdminCard:SendBacKhoa5kv(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddBindMoney(50000000);	--5000v bạc khóa
	pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=gold>5000vạn bạc khóa<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>5000vạn bạc khóa<color>");
end

function tbAdminCard:SendBac4(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.Earn(10000000,0);	--1000v bạc
		pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=gold>1000vạn bạc thường<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>1000vạn bạc thường<color>");
end
function tbAdminCard:SendBac4kv(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.Earn(50000000,0);	--5000v bạc
		pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=gold>5000vạn bạc thường<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>5000vạn bạc thường<color>");
end

function tbAdminCard:SendDongKhoa3(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddBindCoin(1000000);	--100v Đồng khóa
		pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=gold>100vạn đồng khóa<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>100vạn đồng khóa<color>");
end

function tbAdminCard:SendDongKhoa4(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddBindCoin(2000000);	--200v Đồng khóa
		pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=gold>200vạn đồng khóa<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>200vạn đồng khóa<color>");
end

function tbAdminCard:SendDongKhoa5(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddBindCoin(5000000);	--500v Đồng khóa
		pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=gold>500vạn đồng khóa<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>500vạn đồng khóa<color>");
end

function tbAdminCard:SendDongKhoa55(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddBindCoin(-1*5000000);	--500v Đồng khóa
	pPlayer.AddJbCoin(-1*2000000);	--200v Đồng
end
function tbAdminCard:Send100vp(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3019,1,nil,100);
		pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>100 Rương VP<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>100 Rương VP<color>");
end
function tbAdminCard:Send100mg(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3046,1,nil,100);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>100 Rương MG<color>");
    me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>100 Rương MG<color>");
end
function tbAdminCard:thetk(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
		pPlayer.AddStackItem(18,1,3039,5,nil,1);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>1 Lệnh Bài Hoạt Động<color>");
    me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>1 Lệnh Bài Hoạt Động<color>");
end
function tbAdminCard:thetdlp(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3039,5,nil,1);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>LB tham gia Loạn Phái<color>");
    me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>LB tham gia Loạn Phái<color>");
end
function tbAdminCard:SendDong1(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3019,1,nil,50);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>50 Rương VP<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>50 Rương VP<color>");
end

function tbAdminCard:SendDong2(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3046,1,nil,50);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>50 Rương MG<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>50 Rương MG<color>");
end

function tbAdminCard:SendDong3(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddStackItem(18,1,3039,1,nil,50);
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>50 Pháo Hoa<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>50 Pháo Hoa<color>");
end
function tbAdminCard:SendDong20(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddJbCoin(200000);	--20v Đồng
			pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>20 vạn đồng thường<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>20 vạn đồng thường<color>");
end
function tbAdminCard:SendDong50(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddJbCoin(500000);	--100v Đồng
				pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>50 vạn đồng thường<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>50 vạn đồng thường<color>");
end
function tbAdminCard:SendDong4(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddJbCoin(1000000);	--100v Đồng
				pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>100 vạn đồng thường<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>100 vạn đồng thường<color>");
end

function tbAdminCard:SendDong5(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddJbCoin(2000000);	--200v Đồng
				pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>200 vạn đồng thường<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>200 vạn đồng thường<color>");
end

function tbAdminCard:SendDong6(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	pPlayer.AddJbCoin(5000000);	--500v Đồng
				pPlayer.Msg("<color=yellow>Administrator<color> gửi cho bạn <color=green>500 vạn đồng thường<color>");
	me.Msg("Gửi <color=yellow>thành công<color> cho <color=blue>"..pPlayer.szName.."<color> <color=gold>500 vạn đồng thường<color>");
end

function tbAdminCard:NhapSoLuong(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	Dialog:AskString("Số lượng bạc", 3000, self.SendBacKhoa, self); --, nPlayerId
end

function tbAdminCard:SendBacKhoa(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	local nSoluong = 1000000; --100v bạc khóa
	pPlayer.AddBindMoney(nSoluong);
end

function tbAdminCard:SendBac(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	local nSoluong = 1000000; --100v bạc
	pPlayer.Earn(nSoluong,0);
end

function tbAdminCard:SendDong(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
	local nSoluong = 10000; --1v Đồng
	pPlayer.AddJbCoin(nSoluong);
end

function tbAdminCard:SendDKN8(nPlayerId)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
...
-----------------------------
------------------------------------------
function tbAdminCard:guiitem123(nPlayerId)
	Dialog:AskNumber("Nhập Genre",30000, self.Genre21,self, nPlayerId);
end

function tbAdminCard:Genre21(nPlayerId, nGenre)
	Dialog:AskNumber("Nhập Detail",30000,self.Detail21,self, nPlayerId, nGenre);
end

function tbAdminCard:Detail21(nPlayerId, nGenre, nDetail)
	Dialog:AskNumber("Nhập Particular",30000,self.Particular21,self, nPlayerId, nGenre, nDetail);
end

function tbAdminCard:Particular21(nPlayerId, nGenre, nDetail, nParticular)
	Dialog:AskNumber("Nhập Level",30000,self.Level21 ,self, nPlayerId, nGenre, nDetail, nParticular);
end

function tbAdminCard:Level21(nPlayerId, nGenre, nDetail, nParticular, nLevel)
	Dialog:AskNumber("Nhập Số Lượng",30000,self.nSeries21 ,self, nPlayerId, nGenre, nDetail, nParticular, nLevel);
end

function tbAdminCard:nSeries21(nPlayerId, nGenre, nDetail, nParticular, nLevel, nSeries)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
		pPlayer.AddStackItem(nGenre,nDetail,nParticular,nLevel,nil, nSeries);
		pPlayer.Msg("<color=yellow>Administrator<color> gửi tới ngươi 1 món quà");
		me.Msg("Gửi <color=yellow>thành công<color> items");
end
--------------------------------------------
function tbAdminCard:ThemVatPham2(nPlayerId)
	Dialog:AskNumber("Nhập Genre",30000, self.Genre2,self, nPlayerId);
end

function tbAdminCard:Genre2(nPlayerId, nGenre)
	Dialog:AskNumber("Nhập Detail",30000,self.Detail2,self, nPlayerId, nGenre);
end

function tbAdminCard:Detail2(nPlayerId, nGenre, nDetail)
	Dialog:AskNumber("Nhập Particular",30000,self.Particular2,self, nPlayerId, nGenre, nDetail);
end

function tbAdminCard:Particular2(nPlayerId, nGenre, nDetail, nParticular)
	Dialog:AskNumber("Nhập Level",30000,self.Level2 ,self, nPlayerId, nGenre, nDetail, nParticular);
end

function tbAdminCard:Level2(nPlayerId, nGenre, nDetail, nParticular, nLevel)
	Dialog:AskNumber("Nhập Series",30000,self.nSeries2 ,self, nPlayerId, nGenre, nDetail, nParticular, nLevel);
end

function tbAdminCard:nSeries2(nPlayerId, nGenre, nDetail, nParticular, nLevel, nSeries)
	local pPlayer	= KPlayer.GetPlayerObjById(nPlayerId);
...
function tbAdminCard:ReloadScriptDEV()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:ReloadVuHung()
...
function tbAdminCard:NPCEvent()
    DoScript("\\script\\npc\\liguan.lua");
	me.Msg("Đã load lại bộ NPC Event !!! \n<color=yellow> - Nữ Hiệp \n - Anh Hùng<color>");
end

function tbAdminCard:ScriptEvent()
...
function tbAdminCard:NangCao()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
	    {"<color=yellow>Tiền Xu<color>",self.TienXu,self};
...
function tbAdminCard:TienXu()
Dialog:AskNumber("Số Lượng Lấy", 100000, self.laydtv, self);
end
function tbAdminCard:laydtv(szSoLuongVatPham)
me.AddStackItem(18,10,11,2,nil,szSoLuongVatPham);
end
function tbAdminCard:BacDong()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsBangHoiGiaToc()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:LenhBaiGiaTocSo()
	for i=1,5 do
		me.AddItem(18,1,110,1); --Lệnh bài gia tộc sơ
	end
end

function tbAdminCard:LenhBaiGiaTocTrung()
	for i=1,5 do
		me.AddItem(18,1,110,2); --Lệnh bài gia tộc trung
	end
end

function tbAdminCard:LenhBaiGiaTocCao()
	for i=1,5 do
		me.AddItem(18,1,110,3); --Lệnh bài gia tộc cao
	end
end

function tbAdminCard:lsBangHoi()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:BacBangHoiTieu()
	for i=1,5 do
		me.AddItem(18,1,284,1); --Thỏi bạc bang hội tiểu
	end
end

function tbAdminCard:BacBangHoiDai()
	for i=1,5 do
		me.AddItem(18,1,284,2); --Thỏi bạc bang hội đại
	end
end

function tbAdminCard:lsQuanHamQuanAn()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:NhanQuanHam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:quanham1()
	me.AddTitle(10, 2, 1, 8)
end

function tbAdminCard:quanham2()
	me.AddTitle(10, 2, 2, 8)
end

function tbAdminCard:quanham3()
	me.AddTitle(10, 2, 3, 8)
end

function tbAdminCard:quanham4()
	me.AddTitle(10, 2, 4, 8)
end

function tbAdminCard:quanham5()
	me.AddTitle(10, 2, 5, 8)
end

function tbAdminCard:quanham6()
	me.AddTitle(10, 2, 6, 8)
end

function tbAdminCard:quanham7()
	me.AddTitle(10, 2, 7, 8)
end

function tbAdminCard:quanham8()
	me.AddTitle(10, 2, 8, 8)
end

function tbAdminCard:NhanQuanAn()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:QuanAnKim()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:QuanAnKim1()
	me.AddItem(1,18,1,1,1);
end

function tbAdminCard:QuanAnKim2()
	me.AddItem(1,18,1,2,1);
end

function tbAdminCard:QuanAnKim3()
	me.AddItem(1,18,1,3,1);
end

function tbAdminCard:QuanAnKim4()
	me.AddItem(1,18,1,4,1);
end

function tbAdminCard:QuanAnKim5()
	me.AddItem(1,18,1,5,1);
end

function tbAdminCard:QuanAnKim6()
	me.AddItem(1,18,1,6,1);
end

function tbAdminCard:QuanAnKim7()
	me.AddItem(1,18,1,7,1);
end

function tbAdminCard:QuanAnKim8()
	me.AddItem(1,18,1,8,1);
end

function tbAdminCard:QuanAnMoc()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:QuanAnMoc1()
	me.AddItem(1,18,2,1,1);
end

function tbAdminCard:QuanAnMoc2()
	me.AddItem(1,18,2,2,1);
end

function tbAdminCard:QuanAnMoc3()
	me.AddItem(1,18,2,3,1);
end

function tbAdminCard:QuanAnMoc4()
	me.AddItem(1,18,2,4,1);
end

function tbAdminCard:QuanAnMoc5()
	me.AddItem(1,18,2,5,1);
end

function tbAdminCard:QuanAnMoc6()
	me.AddItem(1,18,2,6,1);
end

function tbAdminCard:QuanAnMoc7()
	me.AddItem(1,18,2,7,1);
end

function tbAdminCard:QuanAnMoc8()
	me.AddItem(1,18,2,8,1);
end

function tbAdminCard:QuanAnThuy()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:QuanAnThuy1()
	me.AddItem(1,18,3,1,1);
end

function tbAdminCard:QuanAnThuy2()
	me.AddItem(1,18,3,2,1);
end

function tbAdminCard:QuanAnThuy3()
	me.AddItem(1,18,3,3,1);
end

function tbAdminCard:QuanAnThuy4()
	me.AddItem(1,18,3,4,1);
end

function tbAdminCard:QuanAnThuy5()
	me.AddItem(1,18,3,5,1);
end

function tbAdminCard:QuanAnThuy6()
	me.AddItem(1,18,3,6,1);
end

function tbAdminCard:QuanAnThuy7()
	me.AddItem(1,18,3,7,1);
end

function tbAdminCard:QuanAnThuy8()
	me.AddItem(1,18,3,8,1);
end

function tbAdminCard:QuanAnHoa()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:QuanAnHoa1()
	me.AddItem(1,18,4,1,1);
end

function tbAdminCard:QuanAnHoa2()
	me.AddItem(1,18,4,2,1);
end

function tbAdminCard:QuanAnHoa3()
	me.AddItem(1,18,4,3,1);
end

function tbAdminCard:QuanAnHoa4()
	me.AddItem(1,18,4,4,1);
end

function tbAdminCard:QuanAnHoa5()
	me.AddItem(1,18,4,5,1);
end

function tbAdminCard:QuanAnHoa6()
	me.AddItem(1,18,4,6,1);
end

function tbAdminCard:QuanAnHoa7()
	me.AddItem(1,18,4,7,1);
end

function tbAdminCard:QuanAnHoa8()
	me.AddItem(1,18,4,8,1);
end

function tbAdminCard:QuanAnTho()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:QuanAnTho1()
	me.AddItem(1,18,5,1,1);
end

function tbAdminCard:QuanAnTho2()
	me.AddItem(1,18,5,2,1);
end

function tbAdminCard:QuanAnTho3()
	me.AddItem(1,18,5,3,1);
end

function tbAdminCard:QuanAnTho4()
	me.AddItem(1,18,5,4,1);
end

function tbAdminCard:QuanAnTho5()
	me.AddItem(1,18,5,5,1);
end

function tbAdminCard:QuanAnTho6()
	me.AddItem(1,18,5,6,1);
end

function tbAdminCard:QuanAnTho7()
	me.AddItem(1,18,5,7,1);
end

function tbAdminCard:QuanAnTho8()
	me.AddItem(1,18,5,8,1);
end

function tbAdminCard:lsDanhVong()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:DanhVongFull()
...
function tbAdminCard:XoaDanhVongFull()
...
function tbAdminCard:ChonDanhVong()
local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {};
...
function tbAdminCard:ChanNguyen()
	me.AddItem(1,24,1,1);
	me.AddItem(1,24,2,1);
	me.AddItem(1,24,3,1);
	me.AddItem(1,24,4,1);
...
function tbAdminCard:ThanhLinh()
	me.AddItem(1,27,1,1);
	me.AddItem(1,27,2,1);
	me.AddItem(1,27,3,1);
	me.AddItem(1,27,4,1);
...
function tbAdminCard:LuyenThanhLinh()
	me.AddStackItem(18,1,1334,1,nil,1000);
end

function tbAdminCard:LuyenChanNguyen()
	me.AddStackItem(18,1,1335,1,nil,1000);
end

function tbAdminCard:LuyenChanVu()
...
function tbAdminCard:NgoaiTrang()
...
function tbAdminCard:NgoaiTrangLuyen()
	me.AddItem(1,25,51,2);
	me.AddItem(1,25,52,2);
	me.AddItem(1,25,53,2);
	me.AddItem(1,25,54,2);
...
function tbAdminCard:TrangBiCuongHoa()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:HeThuy101()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt ={
...
function tbAdminCard:KimNgoai10()
...
function tbAdminCard:KimNgoai101()
...
function tbAdminCard:KimNoi101()
...
function tbAdminCard:MocNgoai10()
...
function tbAdminCard:MocNgoai101()
...
function tbAdminCard:MocNoi101()
...
function tbAdminCard:ThuyNgoai10()
...
function tbAdminCard:ThuyNgoai101()
...
function tbAdminCard:ThuyNoi10()
...
function tbAdminCard:ThuyNoi110()
...
function tbAdminCard:HoaNgoai10()
...
function tbAdminCard:HoaNgoai101()
...
function tbAdminCard:HoaNoi101()
...
function tbAdminCard:ThoNgoai10()
...
function tbAdminCard:ThoNgoai101()
...
function tbAdminCard:ThoNoi101()
...
function tbAdminCard:HeThuy121()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt ={
...
function tbAdminCard:KimNgoai12()
...
function tbAdminCard:KimNgoai121()
...
function tbAdminCard:KimNoi121()
...
function tbAdminCard:MocNgoai12()
...
function tbAdminCard:MocNgoai121()
...
function tbAdminCard:MocNoi121()
...
function tbAdminCard:ThuyNgoai12()
...
function tbAdminCard:ThuyNgoai121()
...
function tbAdminCard:ThuyNoi12()
...
function tbAdminCard:ThuyNoi112()
...
function tbAdminCard:HoaNgoai12()
...
function tbAdminCard:HoaNgoai121()
...
function tbAdminCard:HoaNoi121()
...
function tbAdminCard:ThoNgoai12()
...
function tbAdminCard:ThoNgoai121()
...
function tbAdminCard:ThoNoi121()
...
function tbAdminCard:HeThuy141()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt ={
...
function tbAdminCard:KimNgoai14()
...
function tbAdminCard:KimNgoai141()
...
function tbAdminCard:KimNoi141()
...
function tbAdminCard:MocNgoai14()
...
function tbAdminCard:MocNgoai141()
...
function tbAdminCard:MocNoi141()
...
function tbAdminCard:ThuyNgoai14()
...
function tbAdminCard:ThuyNgoai141()
...
function tbAdminCard:ThuyNoi14()
...
function tbAdminCard:ThuyNoi114()
...
function tbAdminCard:HoaNgoai14()
...
function tbAdminCard:HoaNgoai141()
...
function tbAdminCard:HoaNoi141()
...
function tbAdminCard:ThoNgoai14()
...
function tbAdminCard:ThoNgoai141()
...
function tbAdminCard:ThoNoi141()
...
function tbAdminCard:HeThuy161()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt ={
...
function tbAdminCard:KimNgoai16()
...
function tbAdminCard:KimNgoai161()
...
function tbAdminCard:KimNoi161()
...
function tbAdminCard:MocNgoai16()
...
function tbAdminCard:MocNgoai161()
...
function tbAdminCard:MocNoi161()
...
function tbAdminCard:ThuyNgoai16()
...
function tbAdminCard:ThuyNgoai161()
...
function tbAdminCard:ThuyNoi16()
...
function tbAdminCard:ThuyNoi161()
...
function tbAdminCard:HoaNgoai16()
...
function tbAdminCard:HoaNgoai161()
...
function tbAdminCard:HoaNoi161()
...
function tbAdminCard:ThoNgoai16()
...
function tbAdminCard:ThoNgoai161()
...
function tbAdminCard:ThoNoi161()
...
function tbAdminCard:VoSong()
	me.SetHonorLevel(10);
end

function tbAdminCard:PhiPhong1()
...
function tbAdminCard:PhiPhong2()
...
function tbAdminCard:PhiPhong3()
...
function tbAdminCard:PhiPhong4()
...
function tbAdminCard:PhiPhong5()
...
function tbAdminCard:PhiPhong6()
...
function tbAdminCard:PhiPhong7()
...
function tbAdminCard:PhiPhong8()
...
function tbAdminCard:PhiPhong9()
...
function tbAdminCard:PhiPhong10()
...
function tbAdminCard:ShopLienDau()
    me.OpenShop(134,1);
end

function tbAdminCard:ShopChucPhuc()
    me.OpenShop(133,1);
end

function tbAdminCard:ShopTranhDoat()
    me.OpenShop(147,1);
end

function tbAdminCard:ShopThinhHa()
    me.OpenShop(128,1);
end

function tbAdminCard:SVuKhi1()
	me.OpenShop(156, 1);
end

function tbAdminCard:SVuKhi2()
	me.OpenShop(157, 1);
end

function tbAdminCard:SVuKhi3()
	me.OpenShop(158, 1);
end

function tbAdminCard:SVuKhi4()
	me.OpenShop(159, 1);
end

function tbAdminCard:SVuKhi5()
	me.OpenShop(160, 1);
end

function tbAdminCard:ShopQuanham()
    local nSeries = me.nSeries;
    if (nSeries == 0) then
        Dialog:Say("Bạn hãy gia nhập phái");
        return;
...
function tbAdminCard:lsAoVuUyNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsAoVuUyNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsNhanVuUyNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsNhanVuUyNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsHoPhuVuUyKim()
...
function tbAdminCard:lsHoPhuVuUyMoc()
...
function tbAdminCard:lsHoPhuVuUyThuy()
...
function tbAdminCard:lsHoPhuVuUyHoa()
...
function tbAdminCard:lsHoPhuVuUyTho()
...
function tbAdminCard:lsAoThuyHoang()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsAoThuyHoangNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsAoThuyHoangNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsBaoTayThuyHoangNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsBaoTayThuyHoangNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsBaoTayThuyHoangNamKim()
...
function tbAdminCard:lsBaoTayThuyHoangNamMoc()
...
function tbAdminCard:lsBaoTayThuyHoangNamThuy()
...
function tbAdminCard:lsBaoTayThuyHoangNamHoa()
...
function tbAdminCard:lsBaoTayThuyHoangNamTho()
...
function tbAdminCard:lsBaoTayThuyHoangNuKim()
...
function tbAdminCard:lsBaoTayThuyHoangNuMoc()
...
function tbAdminCard:lsBaoTayThuyHoangNuThuy()
...
function tbAdminCard:lsBaoTayThuyHoangNuHoa()
...
function tbAdminCard:lsBaoTayThuyHoangNuTho()
...
function tbAdminCard:lsNgocBoiThuyHoang()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsNgocBoiThuyHoangNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsNgocBoiThuyHoangNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsBaoTayTieuDaoNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsBaoTayTieuDaoNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsBaoTayTieuDaoNamKim()
...
function tbAdminCard:lsBaoTayTieuDaoNamMoc()
...
function tbAdminCard:lsBaoTayTieuDaoNamThuy()
...
function tbAdminCard:lsBaoTayTieuDaoNamHoa()
...
function tbAdminCard:lsBaoTayTieuDaoNamTho()
...
function tbAdminCard:lsBaoTayTieuDaoNuKim()
...
function tbAdminCard:lsBaoTayTieuDaoNuMoc()
...
function tbAdminCard:lsBaoTayTieuDaoNuThuy()
...
function tbAdminCard:lsBaoTayTieuDaoNuHoa()
...
function tbAdminCard:lsBaoTayTieuDaoNuTho()
...
function tbAdminCard:lsGiayTieuDao()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsGiayTieuDaoNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsGiayTieuDaoNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsNonTrucLocNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsNonTrucLocNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsLungTrucLocNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsLungTrucLocNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsLungTrucLocNamKim()
...
function tbAdminCard:lsLungTrucLocNamMoc()
...
function tbAdminCard:lsLungTrucLocNamThuy()
...
function tbAdminCard:lsLungTrucLocNamHoa()
...
function tbAdminCard:lsLungTrucLocNamTho()
...
function tbAdminCard:lsLungTrucLocNuKim()
...
function tbAdminCard:lsLungTrucLocNuMoc()
...
function tbAdminCard:lsLungTrucLocNuThuy()
...
function tbAdminCard:lsTrucLocNuHoa()
...
function tbAdminCard:lsLungTrucLocNuTho()
...
function tbAdminCard:lsLienTrucLoc()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsLienTrucLocNam()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsLienTrucLocNu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsLienTrucLocNamKim()
	me.AddItem(4,5,457,10); --Liên trục lộc - Kim - Nam
end

function tbAdminCard:lsLienTrucLocNamMoc()
	me.AddItem(4,5,459,10); --Liên trục lộc - Mộc - Nam
end

function tbAdminCard:lsLienTrucLocNamThuy()
	me.AddItem(4,5,461,10); --Liên trục lộc - Thủy - Nam
end

function tbAdminCard:lsLienTrucLocNamHoa()
	me.AddItem(4,5,463,10); --Liên trục lộc - Hỏa - Nam
end

function tbAdminCard:lsLienTrucLocNamTho()
	me.AddItem(4,5,465,10); --Liên trục lộc - Thổ - Nam
end

function tbAdminCard:lsLienTrucLocNuKim()
	me.AddItem(4,5,458,10); --Liên trục lộc - Kim - Nữ
end

function tbAdminCard:lsLienTrucLocNuMoc()
	me.AddItem(4,5,460,10); --Liên trục lộc - Mộc - Nữ
end

function tbAdminCard:lsLienTrucLocNuThuy()
	me.AddItem(4,5,462,10); --Liên trục lộc - Thủy - Nữ
end

function tbAdminCard:lsLienTrucLocNuHoa()
	me.AddItem(4,5,464,10); --Liên trục lộc - Hỏa - Nữ
end

function tbAdminCard:lsLienTrucLocNuTho()
	me.AddItem(4,5,466,10); --Liên trục lộc - Thổ - Nữ
end

function tbAdminCard:LuanHoiAn()
...
function tbAdminCard:TranPhapCao()
...
function tbAdminCard:ManhTinhThach()
	for i=1,100 do
...
function tbAdminCard:RuongPhiThienVu()
	for i=1,100 do
		me.AddItem(18,10,12,13); --Rương Phi Thiên Vũ
	end
end

function tbAdminCard:HoaThiNgoc()
	for i=1,5 do
...
function tbAdminCard:TangBaoDo()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:VeCuongHoaVuKhi()
	me.AddItem(18,1,518,1,0,1); --Vé Cường Hóa Vũ Khí
end

function tbAdminCard:VeCuongHoaPhongCu()
	me.AddItem(18,1,519,1,0,1); --Vé Cường Hóa Phòng Cụ
end

function tbAdminCard:VeCuongHoaTrangSuc()
	me.AddItem(18,1,520,1,0,1); --Vé Cường Hóa Trang Sức
end

function tbAdminCard:LuyenHoaDo()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:BoThuyHoang()
...
function tbAdminCard:BoTrucLoc()
...
function tbAdminCard:BoTieuDao()
...
function tbAdminCard:HuyenTinh1()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:HuyenTinh2()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:HuyenTinh4()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
			me.AddItem(18,1,1,4);
		else
...
function tbAdminCard:BuaSuaTrangBi()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:RuongVoSoVang()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:RuongCaoQuy()
	for i=1,20 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:RuongDaMinhChau()
	me.AddItem(18,1,382,1); --Rương dạ minh châu
end

function tbAdminCard:TuLuyenDon()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:TinhLucHoatLuc()
...
function tbAdminCard:NguHoaNgocLoHoan()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:VanVatQuyNguyenDon()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:ToTienBaoHo()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsTrungDuLong()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:ChienThuDuLong()
	for i=1,100 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:DuLongDanhVongLenh()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsDanhBoLenh()
	for i=1,300 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:lsBachHoDuong()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:BachHoDuongSo()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:BachHoDuongTrung()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:BachHoDuongCao()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:lsChucPhuc()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:ChucPhucSo()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:ChucPhucTrung()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:ChucPhucCao()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:lsThuCuoiDongHanh()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsThuCuoi()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsThuCuoi1()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:DayCuongThanBi()
	me.AddItem(18,1,237,1); --Dây cương thần bí
end

function tbAdminCard:PhienVu()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:BanDongHanh()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:BanDongHanh6KN()
	me.AddItem(18,1,547,2); --Đồng hành 6 KN
	me.AddItem(18,1,547,2); --Đồng hành 6 KN
end

function tbAdminCard:BanDongHanh4KN()
	me.AddItem(18,1,547,1); --ĐH 4KN
	me.AddItem(18,1,547,1); --ĐH 4KN
end

function tbAdminCard:BanDongHanhVL()
	me.AddItem(18,1,547,1); --ĐH 4KN
	me.AddItem(18,1,547,1); --ĐH 4KN
end
...
function tbAdminCard:NguyenLieuDongHanh()
	me.AddItem(18,1,556,1); -- nguyen lieu dong hanh dac biet
end

function tbAdminCard:lsSachKinhNghiemDongHanh()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:SachKinhNghiemDongHanh1()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:SachKinhNghiemDongHanh2()
	for i=1,10 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:ThiepBacThiepLua()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:lsChuyenSinhPet()
    me.AddItem(18,1,564,1); --Bồ Đề Quả - Chuyển sinh cho PET
end

function tbAdminCard:ThuDongHanh()
    me.AddItem(18,1,566,1,0,1); --Thư Đồng Hành
end

function tbAdminCard:BachNganTinhHoa()
	me.AddItem(18,1,565,1); --Bạch ngân tinh hoa
end

function tbAdminCard:lsGoiBoss()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:LenhBaiPhoBan()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {
...
function tbAdminCard:LenhBaiThienQuynhCung()
    me.AddItem(18,1,186,1); --Lệnh Bài Thiên Quỳnh Cung
end

function tbAdminCard:LenhBaiVanHoaCoc()
    me.AddItem(18,1,245,1); --Lệnh Bài Vạn Hoa Cốc
end

function tbAdminCard:lsTiemNangKyNang()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = { 		
...
function tbAdminCard:MaxSkillMonPhai() 
    if me.nFaction > 0 then 
...
function tbAdminCard:DiemTiemNang()
	me.AddPotential(1000)
end

function tbAdminCard:DiemKyNang()
	me.AddFightSkillPoint(20)
end

function tbAdminCard:XoaDiemTiemNang()
	me.AddPotential(-1*1000)
end

function tbAdminCard:XoaDiemKyNang()
	me.AddFightSkillPoint(-1*79)
end

function tbAdminCard:skill120()
if me.nFaction > 0 then 
        if me.nFaction == 1 then    --Skill Thiếu Lâm 
...
function tbAdminCard:mttl()
	me.AddItem(1,14,1,3);
	me.AddItem(1,14,2,3);
end

function tbAdminCard:mttv()		
	me.AddItem(1,14,3,3);
	me.AddItem(1,14,4,3);
end

function tbAdminCard:mtdm()
	me.AddItem(1,14,5,3);
	me.AddItem(1,14,6,3);
end

function tbAdminCard:mtnd()		
	me.AddItem(1,14,7,3);
	me.AddItem(1,14,8,3);
end

function tbAdminCard:mtmg()		
	me.AddItem(1,14,21,3);
	me.AddItem(1,14,22,3);
end

function tbAdminCard:mtnm()
	me.AddItem(1,14,9,3);
	me.AddItem(1,14,10,3);
end

function tbAdminCard:mtty()		
	me.AddItem(1,14,11,3);
	me.AddItem(1,14,12,3);
end

function tbAdminCard:mtdt()		
	me.AddItem(1,14,23,3);
	me.AddItem(1,14,24,3);
end

function tbAdminCard:mtcb()
	me.AddItem(1,14,13,3);
	me.AddItem(1,14,14,3);
end

function tbAdminCard:mttn()		
	me.AddItem(1,14,15,3);
	me.AddItem(1,14,16,3);
end

function tbAdminCard:mtvd()
	me.AddItem(1,14,17,3);
	me.AddItem(1,14,18,3);
end

function tbAdminCard:mtcl()		
	me.AddItem(1,14,19,3);
	me.AddItem(1,14,20,3);
end

function tbAdminCard:lsMatTichTrung()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = {};
...
function tbAdminCard:VoLamMatTich()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:TayTuyKinh()
	for i=1,5 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:lsDiemKinhNghiem()
	local szMsg = "<pic=28>Game Master Cards \n Chào Admin <color=red>"..me.szName.. "<color> <pic=98> \n Kiếm Thế Chí Tôn";
	local tbOpt = { 		
...
function tbAdminCard:LenLevel110()
	me.AddLevel(110 - me.nLevel);
end

function tbAdminCard:LenLevel130()
	me.AddLevel(130 - me.nLevel);
end

function tbAdminCard:LenLevel140()
...
function tbAdminCard:DiemKinhNghiem()
	me.AddExp(500000000);
end

function tbAdminCard:BanhItThitHeo()
	for i=1,20 do
		if me.CountFreeBagCell() > 0 then
...
function tbAdminCard:TangTocChay()
...
function tbAdminCard:HuyTangTocChay()
...
function tbAdminCard:TangTocDanh()
...
function tbAdminCard:HuyTangTocDanh()
	me.DelFightSkill(68);
	me.DelFightSkill(75);
...
function tbAdminCard:TrangBiBaVuong()
	local nSeries = me.nSeries;
...
function tbAdminCard:TrangBiSatThan()
	local nSeries = me.nSeries;
...
function tbAdminCard:ComeHereAll()
	local nMapId, nMapX, nMapY = me.GetWorldPos();
	me.Msg("Đã triệu tập !");
	self:RemoteCall_ApplyAll("me.NewWorld", nMapId, nMapX, nMapY);
end

function tbAdminCard:ListAllPlayer()
	local tbOpt	= {};
	for nPlayerId, tbInfo in pairs(self.tbRemoteList) do
		tbOpt[#tbOpt+1]	= {"<color=green>"..tbInfo[1], self.SelectPlayer, self, nPlayerId, tbInfo[1]};
	end
...
function tbAdminCard:SelectPlayer(nPlayerId, szPlayerName)
	-- 插入最近操作玩家
...
function tbAdminCard:CallSomeoneHere(nPlayerId)
	local nMapId, nMapX, nMapY = me.GetWorldPos();
...
--== 全服玩家列表 ==--
-- 将本服务器玩家列表发送出去
function tbAdminCard:RemoteList_Fetch(nToPlayerId)
...
-- 收到传回的玩家列表
function tbAdminCard:RemoteList_Receive(nToPlayerId, tbRemoteList)
...
--== 全服/单一玩家执行 ==--
-- 申请为全服玩家执行
function tbAdminCard:RemoteCall_ApplyAll(...)
	GlobalExcute({"GM.tbPlayer:RemoteCall_DoAll", arg})
end
-- 为本服务器玩家执行
function tbAdminCard:RemoteCall_DoAll(tbCallBack)
	local tbLocalPlayer = KPlayer.GetAllPlayer();
	for _, pPlayer in pairs(tbLocalPlayer) do
...
-- 申请为单一玩家执行
function tbAdminCard:RemoteCall_ApplyOne(nToPlayerId, ...)
	GlobalExcute({"GM.tbPlayer:RemoteCall_DoOne", nToPlayerId, arg})
end
-- 为本服务器玩家执行
function tbAdminCard:RemoteCall_DoOne(nToPlayerId, tbCallBack)
	local pPlayer	= KPlayer.GetPlayerObjById(nToPlayerId);
	if (pPlayer) then
		pPlayer.Call(unpack(tbCallBack));
	end
