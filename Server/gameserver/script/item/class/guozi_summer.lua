...
tbItem.tbBoss = {
	{"<color=gold>Uy danh của võ sư vàng<color>",100 , 1},
	{"<color=green>Võ sư gỗ uy tín<color>",100, 2},
	{"<color=blue>Hệ thống nước võ sư uy tín<color>",100, 3},
	{"<color=red>Hỏa võ sư uy danh<color>",100, 4},
	{"<color=wheat>Uy tín<color>",100, 5},
};
...
function tbItem:OnUse()
	...
	if nType and nType >= 0 and nTime and nTime > 0 then
		table.insert(tbOpt, 3, {"Đổi lại trái cây mùa hè không giới hạn thời gian", self.ChangeItem, self, it.dwId});
	end
