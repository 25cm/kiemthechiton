...
function tbMenPaiNpc:FactionDialog(fnCall)
	...
	Dialog:Say("Chọn môn phái:", tbOpt)
end;
	...
	if (me.nFaction and me.nFaction ~= 0) then
		...
		if (nFaction == me.nFaction) then
			local tbOpt	= {
							...
							{"[Tham Gia] <color=yellow>Thi Đấu Loạn Phái<color>", FactionBattle.ChoiceFunc, FactionBattle, nFaction},
							--{"<color=green>Gia Nhập Môn Phái<color>", FactionBattle.ChoiceFunc, FactionBattle, nFaction},
							...
							{"Vào Tẩy Tủy Đảo tẩy điểm", Xisuidao.OnEnterXisuidao_Xidian, Xisuidao, me},
							{"Phụ tu các môn phái khác", Xisuidao.OnEnterXisuidao_Duoxiu, Xisuidao, me},
