...
function tbBag_1:OnDialog()
	...
	GeneralProcess:StartProcess("Đang mở...", 1 * 18, {self.OnOpen, self, me.nId, him.dwId}, {me.Msg, "Mở bị gián đoạn"}, tbEvent);
...
function tbBag_2:OnOpen(nPlayerId, dwNpcId)
	...
	if (pNpc and pNpc.nIndex > 0) then
		...
		-- 通知附近的玩家
		TreasureMap:NotifyAroundPlayer(pPlayer, "<color=yellow>"..pPlayer.szName.." nhận được 1 Đàn cổ!<color>");		
