...
function tbNpc_3:OnDeath(pNpc)
	...
	if (pPlayer) then
		...
		pPlayer.Msg("Bạn đã tiêu diệt <color=green>Boss cuối Đào Chu Công Nghi Chủng<color> nhận được: <color=yellow>10 vạn đồng thường<color>");
		
----------------------------------------
        GlobalExcute({"Dialog:GlobalNewsMsg_GS","Người chơi <color=green>"..pPlayer.szName.."<color> tiêu diệt Boss Tàng Bản Đồ <color=red>Đào Chu Công Nghi Chủng<color> nhận được <color=gold>10 Vạn Đồng<color>"});
		KDialog.MsgToGlobal("Người chơi <color=green>"..pPlayer.szName.."<color> tiêu diệt Boss Tàng Bản Đồ <color=gold>Đào Chu Công Nghi Chủng<color> nhận được <color=yellow>10 Vạn Đồng<color>");
