...
local tbItem = Item:GetClass("tui_top3tk")
...
function tbItem:OnUse()
	...
	me.AddStackItem(18,1,3039,1,nil,6);        --ruongvp	
	me.AddStackItem(18,1,1333,10,nil,8);   --chan nguyen
	me.AddStackItem(18,1,1334,10,nil,20);        --thanh linh
	me.AddStackItem(18,1,377,1,nil,1);           --htb
	me.AddStackItem(18,1,553,1,tbItemInfo,80);     --đong hanh 4skill
	--me.AddStackItem(18,1,1331,2,nil,3);  --tinh thach doan hai
	me.AddStackItem(18,1,325,1,nil,40);
	me.AddStackItem(18,1,2094,1,tbItemInfo,12);
