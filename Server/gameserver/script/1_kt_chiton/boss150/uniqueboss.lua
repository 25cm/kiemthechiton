...
function tbWorldBossBase:OnDeath(pNpcKiller, nFlag)
	...
	if (pPlayer) then
		...
		pPlayer.Msg("<color=blue>Bạn đã tiêu diệt Boss 45 nhận được:<color> <color=yellow>4 vạn đồng thường<color>");
		--------------------------------------------
				GlobalExcute({"Dialog:GlobalNewsMsg_GS","Người chơi<color=green>"..pPlayer.szName.."<color> đánh bại Võ Lâm Cao Thủ <color=red>"..him.szName.."<color> nhận được <color=gold>4 Vạn Đồng<color>"});
		KDialog.MsgToGlobal("Người chơi<color=green>"..pPlayer.szName.."<color> đánh bại Võ Lâm Cao Thủ <color=gold>"..him.szName.."<color> nhận được <color=yellow>4 Vạn Đồng<color>");
		-------------------------------
