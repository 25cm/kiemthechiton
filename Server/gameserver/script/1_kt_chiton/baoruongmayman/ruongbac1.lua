local tbruongbac1 = Npc:GetClass("ruongbac1");
function tbruongbac1:OnDialog()
	local tbEvent = 
	{
...
function tbruongbac1:ThuThap111(nPlayerId, nNpcId)
local pPlayer = KPlayer.GetPlayerObjById(nPlayerId)
	...
	me.AddExp(300000);
	me.Msg("Nhận được <color=yellow>2 Vạn Đồng Khóa<color>");
