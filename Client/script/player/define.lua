...
Player.FACTION_SHAOLIN		= 1;		-- 少林
Player.FACTION_TIANWANG		= 2;		-- 天王
Player.FACTION_TANGMEN		= 3;		-- 唐门
Player.FACTION_WUDU			= 4;		-- 五毒
Player.FACTION_EMEI			= 5;		-- 峨嵋
Player.FACTION_CUIYAN		= 6;		-- 翠烟
Player.FACTION_GAIBANG		= 7;		-- 丐帮
Player.FACTION_TIANREN		= 8;		-- 天忍
Player.FACTION_WUDANG		= 9;		-- 武当
Player.FACTION_KUNLUN		= 10;		-- 昆仑
Player.FACTION_MINGJIAO		= 11;		-- 明教
Player.FACTION_DUANSHI		= 12;		-- 大理段氏
Player.FACTION_NUM			= 12;		-- 门派数量
