...
function tbNpc:OnDialog()
	...
	Dialog:Say("<color=yellow>Bạch Hổ Đường<color> chỉ mở từ <color=green>(8h đến 18h)<color> và <color=green>(22h đến 24h)<color> hàng ngày.<enter>+ <color=green>Thủ Lĩnh BHĐ tầng 1<color> xuất hiện khi thời gian còn: <color=gold>25phút<color>.<enter>+ <color=green>Thủ Lĩnh BHĐ tầng 2<color> xuất hiện khi thời gian còn: <color=gold>18phút<color>.<enter>+ <color=green>Thủ Lĩnh BHĐ tầng 3<color> xuất hiện khi thời gian còn: <color=gold>10phút<color>.<enter>Mỗi ngày có thể tham gia <color=red>Bạch Hổ Đường<color> tối đa: <color=yellow>2 lần<color>.", tbOpt);
