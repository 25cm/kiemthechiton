			...
			function(tbMagic1, tbSkillInfo, tbMagic2, bEx2)
				if (FightSkill.MAGIC_INVALID == tbMagic1[3]) then
					local tbAddSkillType = {
							...
							[2] = "Bí kíp",	--2
							[3] = "Đồng hành",	--4
							[4] = "Có thể kích hoạt thuộc tính thần sa",	--5
						};
					local szMsg = "";
					for i=0,31 do
							if tbMagic1[2] == 5 then
							szMsg = szMsg..tbAddSkillType[4];--Có thể kích hoạt thuộc tính thần sa
							return szMsg;
						elseif tbMagic1[2] == 6 then
							szMsg = szMsg..tbAddSkillType[5];
							return szMsg;
