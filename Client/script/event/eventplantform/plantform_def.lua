...
EPlatForm.DEF_STATE_MSG = {
	[EPlatForm.DEF_STATE_CLOSE]			= "Trạng thái mở",
	[EPlatForm.DEF_STATE_REST]			= "Giải lao",
	[EPlatForm.DEF_STATE_MATCH_1]		= "Vòng loại gia tộc",
	[EPlatForm.DEF_STATE_MATCH_2]		= "Vòng dự tuyển gia tộc",	
	[EPlatForm.DEF_STATE_ADVMATCH]		= "Chung kết gia tộc",
};
...
EPlatForm.MIS_UI_LOOKER = "<color=green>Sinh lực đội %s: <color=red>\n    %s\n\n<color=green>Sinh lực đội %s: \n    <color=blue>%s";
