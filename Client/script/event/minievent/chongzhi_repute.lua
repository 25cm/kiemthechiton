...
tbChongZhi.TSK_JIHUO = 75;
tbChongZhi.DEF_COUNT_MAX = {1,3};

tbChongZhi.DEF_WEEK_REPUTE = {10,20};
...
function tbChongZhi:CheckISCanGetRepute()
	...
	local nDate = me.GetTask(self.TSK_GROUP, self.TSK_JIHUO);
...
function tbChongZhi:SetJiHuoPerMonth()
	...
	local nCurDate = tonumber(GetLocalDate("%Y%m"));
	me.SetTask(self.TSK_GROUP, self.TSK_JIHUO, nCurDate);
