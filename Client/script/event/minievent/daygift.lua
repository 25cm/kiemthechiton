...
tbPhanThuong.Relay_Time = 10*60; --thời gian giữa 2 lần nhận mình để 30p 1 lần
...
function tbPhanThuong:OnDialog()
	...
	szMsg = szMsg.."\n<color=green>Lần 3:<color> "..((nCount >= 3 and szColor) or "").."500 Điểm Danh Vọng Tần Lăng - Vũ Khí<color>";
...
function tbPhanThuong:nhanthuong()
	...
	elseif (nCount == 2) then
		me.AddRepute(9,2,500); --phần thưởng thứ 3
	end
